...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  if (isset($_POST['most_popular_submit'])) {
...
<section id="popular-products">
  <div class="container py-5 bg-light">
    <h4 class="font-rubik font-size-20 biggerFont">
